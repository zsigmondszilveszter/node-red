...
RED.projects.userSettings = (function() {
    ...
    function createWorkflowSection(pane) {
        ...
        var workflowContainer = $('<div class="user-settings-section"></div>').appendTo(pane);
        $('<div style="color:#aaa;"></div>').appendTo(workflowContainer).text(RED._("editor:sidebar.project.userSettings.workfowTip"));

        var row = $('<div class="user-settings-row"></div>').appendTo(workflowContainer);
        ...
        row = $('<div class="user-settings-row"></div>').appendTo(workflowContainer);
