...
var jwt_verifier = require("nc-package-jwt-node");

var bearerStrategy = function (accessToken, done) {
    // is this a valid token?
    jwt_verifier.verify(accessToken).then(result => {
        Users.get(result).then(function (user) {
            if (user) {
                done(null,user,{scope: user.permissions});
            } else {
